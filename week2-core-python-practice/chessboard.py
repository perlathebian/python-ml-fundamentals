...
"""
Interactive ASCII chess board.

Displays a chess board in the terminal and lets the user move, add,
remove, or reset pieces using text commands. The board is stored as a
dictionary of occupied squares only. No chess rules are enforced.
"""
